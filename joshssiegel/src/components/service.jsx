...
export default class Service extends Component {
  ...
  <div className="container">
    ...
    <div className="row services text-center">
      <div data-animate="fadeInUp" className="col-lg-4">
        ...
        <p className="text-left description">
          On on produce colonel pointed. Just four sold need over how any. In to
          september suspicion determine he prevailed admitting. On adapted an as
          affixed limited on. Giving cousin warmly things no spring mr be
          abroad. Relation breeding be as repeated strictly followed margaret.
          One gravity son brought shyness waiting regular led ham.
        </p>
      </div>
      <div data-animate="fadeInUp" className="col-lg-4">
        <div className="icon">
    ...
    <div data-animate="fadeInUp" className="text-center">
      ...
      <p>
        <a href="#contact" className="btn btn-outline-light link-scroll">
          Contact me
        </a>
      </p>
    </div>
